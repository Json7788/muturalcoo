...
public final class ThreadManager {
     ...
     * 手表蓝牙BLE线程
     */
    private static HandlerThread WATCH_BLE_THREAD;
    /**
     * 手表蓝牙BLE线程的Handle
     */
    private static Handler WATCH_BLE_THREAD_HANDLER;
...
//                }
    ...
    //region ================================== 手表蓝牙BLE线程 相关 ==================================
//    public static Thread getWatchBleThread() {
//        if (WATCH_BLE_THREAD == null) {
//            getSubThread2Handler();
//        }
//        return WATCH_BLE_THREAD;
//    }

    /**
     * 获得手表蓝牙ble的Handler.<br>
     *
     * @return handler
     */
    public static Handler getWatchBleThreadHandler() {
        Logger.i(Logger.DEBUG_TAG, "getWatchBleThreadHandler WATCH_BLE_THREAD_HANDLER is null:" + (WATCH_BLE_THREAD_HANDLER == null)
                + ",WATCH_BLE_THREAD is null:" + (WATCH_BLE_THREAD == null));
        if (WATCH_BLE_THREAD_HANDLER == null) {
            synchronized (ThreadManager.class) {
                WATCH_BLE_THREAD = new HandlerThread("WatchBle");
//                WATCH_BLE_THREAD.setPriority(Thread.NORM_PRIORITY);//降低线程优先级
                WATCH_BLE_THREAD.start();
                WATCH_BLE_THREAD_HANDLER = new Handler(WATCH_BLE_THREAD.getLooper());
            }
        }
        return WATCH_BLE_THREAD_HANDLER;
    }

//    public static Looper getWatchBleThreadLooper() {
//        return getWatchBleThreadHandler().getLooper();
//    }
     ...
     */
    public static boolean executeOnWatchBleThread(Runnable run) {
        return getWatchBleThreadHandler().post(run);
    }
    //endregion ================================== 手表蓝牙BLE线程 相关 ==================================
}
